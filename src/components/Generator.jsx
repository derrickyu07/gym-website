...
export default function Generator(props) {
    ...
    return (
        <SectionWrapper id={'generate'} header={"generate your workout"} title={['It\'s', 'Lifting', 'Time']}>
            <Header index={'01'} title={'Pick your split'} description={"Select the workout you wish to endure."} />
            ...
            <Header index={'02'} title={'Lock On Muscle Fibers'} description={"Select the muscle group."} />
            ...
            <Header index={'03'} title={'Choose Your Goal'} description={"Select your ultimate objective."} />
